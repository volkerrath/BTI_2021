...
POM             = -4; 
POR             =   0.01;
KTop            =   3.3;   % mean aus TC-m top 100
...
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% VARIABLES OUTSIDE AAR_PREP OVERWRITE DEFAULTS ABOVE!
...
PORs = prop2cell(POR,zK,z,0.3,0.17,'a');
RHOBs = prop2cell(RHOB,zK,z,2200.,2400.,'a');
RHOCs = prop2cell(RHOC,zK,z,2000.,1700.,'a');
RHPs = prop2cell(RHP,zK,z,300000.,700000.,'a');
rm = RHOBs; 
cpm = RHOCs; 
