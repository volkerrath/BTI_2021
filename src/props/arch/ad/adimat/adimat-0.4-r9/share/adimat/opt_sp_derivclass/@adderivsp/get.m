...
%ADDERIVSP/GET Get the derivative or option.
%
...
if (isa(arg, 'double') && isequal(size(arg),[1 1])) || ...
  (ischar(arg) && arg(1)== ':')
   arg= {arg};
end
...
elseif isa(arg, 'cell')  % Copied from subsref.m
   ...
   error('Invalid argument to adderivsp/get()-method.');
end
