function h_res= ls_hquot(h_s1, g_s1, s1, h_s2, g_s2, s2, g_res)
%ADDERIV/LS_HQUOT Execute the elementwise quotient rule for Hessians.
%
...
for i= 1: h_res.ndd(1)
   for j= 1: h_res.ndd(2)
      h_res.deriv{i,j}=(h_s1.deriv{i,j}.* s2- s1.* h_s2.deriv{i,j}).* denom- ...
