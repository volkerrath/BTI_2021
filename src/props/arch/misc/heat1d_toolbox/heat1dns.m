function [T,z,k_eff,ipor] ...
    = heat1dns(kl,kAl,kBl,hl,porl,Qb,Ts,index,dz,maxiter,tol,freeze,out)


% HEAT1DNS solves nonlinear stationary heat equation
% for general 1D grids (permafrost included).
%
% T = heat1dns(k,kA,kB,h,por,Qb,Ts,index,dz,maxiter,tol,out) calculates
...
% V. R., May 18, 2005
solver='direct';
% solver='bicgstab',tolit=1.e-12;lutol=1.e-6;
mean='g';Tf=0;w=1;
